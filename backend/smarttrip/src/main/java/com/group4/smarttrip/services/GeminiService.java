    ...
    public String callGemini(String userInput) {
     ...
     private String buildPrompt(String userInput) {
        return "You are a travel assistant for SmartTrip NYC. " +
                ...
                "\n" +
                "- If user input doesn’t specify a location, set \"zoneName\" to Times Square.\n" +
                ...
                "- For a day trip, must contain at least 4 different placeCategories, for a half-day trip, must contain at least 3 different placeCategories.\n" +
                "\n" +
                "Examples:\n" +
                "\n" +
                ...
                "     \"startingTime\": 12,\n" +
                "     \"duration\": 6,\n" +
                "     \"placeCategory\": [\"cafe\", \"gallery\", \"artwork\"]\n" +
                "   }\n" +
                "\n" +
                ...
                "     \"startingTime\": 9,\n" +
                "     \"duration\": 9,\n" +
                "     \"placeCategory\": [\"zoo\", \"aquarium\", \"ice_cream\", \"toys\"]\n" +
                "   }\n" +
                "\n" +
                ...
                "     \"startingTime\": 9,\n" +
                "     \"duration\": 9,\n" +
                "     \"placeCategory\": [\"gallery\", \"cafe\", \"artwork\", \"viewpoint\"]\n" +
                "   }" +
